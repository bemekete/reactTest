                    ...
                    <div class="find_form_wrap">
                        ...
                        <form action="#" id="find_form">
                            <div class="form_container">
                                        ...
                                        <dl>
                                            ...
                                            <dd>
                                                <div class="input_line">
                                                    <input class="input_type1" type="text"
                                                        id="user_email" name="user_email"
                                                        maxlength="50" placeholder="ID(이메일) 주소 입력"
                                                        required />
                                                </div>
                                            </dd>
                                        </dl>
                                    ...
                                    <li>
                                        <dl>
                                            ...
                                            <dd>
                                                ...
                                                <div class="input_line">
                                                    <input class="input_type1" type="text"
                                                        id="check_num" name="check_num"
                                                        maxlength="15" placeholder="인증번호 입력" />
                                ...
                                <a href="#" class="btnList" onclick="find_check()">비밀번호 찾기</a>
                            </div>
                        </form>
                    </div>
                </div>
